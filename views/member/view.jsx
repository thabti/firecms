  ...
  render() {
    ...
    var listItem = items ? Object.keys(items).map((object, i) => {
      ...
      return (<li key={object}>
        ...
        <a href={`/member/delete/${object}`} className="fire-cms__icon-link"> <Glyph icon="trashcan" /></a>
        <a href={`/member/edit/${object}`}  className="fire-cms__icon-link"> <Glyph icon="pencil" /></a>
        <hr />
